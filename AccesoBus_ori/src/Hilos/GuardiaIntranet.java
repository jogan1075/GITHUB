...
public class GuardiaIntranet extends AsyncTask <Void, Void, Void> {
	String UID = "";
	String EstadoUID = "";
...
ImageView img;
	...
	public GuardiaIntranet(Context contexto,ImageView imagenfoto){
		...
		if(!Restantes.isEmpty()){
			...
			//	int datosrestantes = (Integer.parseInt(Restantes));
				...
				if (_Exception == null) {
					...
					new GuardiaIntranet(c,img).execute();
				} else {
				...
				//new PersonaIntranet(c,img).execute();
			}
